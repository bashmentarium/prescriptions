...
// Custom Typography for Seniors - Larger, Bolder, More Readable
val SeniorTypography = androidx.compose.material3.Typography(
...
fun WhitelabelTheme(
    ...
    MaterialTheme(
        ...
        typography = SeniorTypography, // Use our custom senior-friendly typography
        content = content
    )
}